...
def write_phase7_ml_report(tier_results, output_dir):
    ...
    for tier in tier_results:
        ...
        row = {
            ...
            "acceptance_by_regime": metrics.get("acceptance_by_regime", {}),
            "avg_threshold_modifier": metrics.get("avg_threshold_modifier", 0.0),
            "phase74_safe_count": metrics.get("phase74_safe_count", 0),
            "phase74_warning_count": metrics.get("phase74_warning_count", 0),
            "phase74_no_trade_count": metrics.get("phase74_no_trade_count", 0),
            "phase74_warning_penalty_count": metrics.get("phase74_warning_penalty_count", 0),
            "phase74_trend_override_count": metrics.get("phase74_trend_override_count", 0),
            "phase74_avg_risk_pressure": metrics.get("phase74_avg_risk_pressure", 0.0),
            "phase74_veto_share_ml_valid": metrics.get("phase74_veto_share_ml_valid", 0.0),
            "phase74_blocked_ml_valid_count": metrics.get("phase74_blocked_ml_valid_count", 0),
            "phase74_ml_valid_candidates": metrics.get("phase74_ml_valid_candidates", 0),
            "phase74_reason_breakdown": metrics.get("phase74_reason_breakdown", {}),
    ...
    metrics_payload = {
        ...
        "acceptance_by_regime_by_tier": {r["tier_name"]: r.get("acceptance_by_regime", {}) for r in scaling_matrix},
        "avg_threshold_modifier_by_tier": {r["tier_name"]: r.get("avg_threshold_modifier", 0.0) for r in scaling_matrix},
        "phase74_safe_count_by_tier": {r["tier_name"]: r.get("phase74_safe_count", 0) for r in scaling_matrix},
        "phase74_warning_count_by_tier": {r["tier_name"]: r.get("phase74_warning_count", 0) for r in scaling_matrix},
        "phase74_no_trade_count_by_tier": {r["tier_name"]: r.get("phase74_no_trade_count", 0) for r in scaling_matrix},
        "phase74_veto_share_ml_valid_by_tier": {r["tier_name"]: r.get("phase74_veto_share_ml_valid", 0.0) for r in scaling_matrix},
        "phase74_avg_risk_pressure_by_tier": {r["tier_name"]: r.get("phase74_avg_risk_pressure", 0.0) for r in scaling_matrix},
